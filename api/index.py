...
def home_page():
    body = """
        <div class="grid">
          <div>
            <div class="eyebrow">Forgeon · Flask playground</div>
            <h1>Flask3 boilerplate, ready for deploy tests.</h1>
            <p>
              This service is a small Flask app you can use to test routing,
          ...
          <div>
            <div class="links">
              ...
              <a href="/framework">
                /framework
                <span>– stack: Flask, Python, etc.</span>
              </a>
              <a href="/status">
                /status
        ...
        <div class="meta">
          <span>Try deploying this to Forgeon as a simple Flask playground.</span>
          <span class="badge">127.0.0.1:5000</span>
        </div>
    """
    return html_shell("Forgeon Flask playground", body)
...
def info_page():
    body = """
        ...
        <div class="grid">
          <div>
            ...
            <h1>flask-playground · Forgeon-ready microservice</h1>
            <p>
    ...
    """
    return html_shell("Forgeon · Flask Playground · Info", body)
...
def about_page():
    body = """
        ...
        <div>
          ...
          <h1>Flask app wired for Forgeon.</h1>
          <p>
            This tiny service is a <strong>Flask</strong> playground used to test how
    ...
    """
    return html_shell("Forgeon · About this Flask demo", body)
...
def framework_page():
    body = """
        ...
        <div class="grid">
          <div>
            ...
            <h1>Built with Flask & Python.</h1>
            <p>
              The service uses <strong>Flask</strong> for routing and responses, typically
              served by <strong>gunicorn</strong> or another WSGI server behind Forgeon. In
              playground mode it runs without any database.
            </p>
          </div>
    ...
    """
    return html_shell("Forgeon · Flask Framework stack", body)
